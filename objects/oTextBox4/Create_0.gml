...
boss_portraits_height = sprite_get_height(sBoss4Portraits);
boss_portraits_width = sprite_get_width(sBoss4Portraits);
...
text_color = c_white;
text[0] = "I am so sad. I can't find my toy right now";
text[1] = "Could you stay here and play with me?";
page = 0;
/// typewriter effect
index = 0;
